<?php
	...
	$related_collect = get_field('collection_category_related_collection', $term->taxonomy . '_' . $term->term_id);
		...
		<div class='container_wrap container_wrap_first main_color <?php avia_layout_class( 'main' );?>'>
			...
			<div class='container'>
				...
				<main class='template-page template-collection content  <?php avia_layout_class( 'content' ); ?> units <?php echo $main_class; ?>' <?php avia_markup_helper( array( 'context' => 'content', 'post_type' => 'product' ) );?>>
					...
					<!-- collection list -->
					<?php echo get_collections_html(0, 12, null, true, 'collection-list-container container'); ?>
						...
						<?php foreach($related_projects as $project): ?>
							<a href="<?php echo get_permalink( $project ) ?>">
								<div class="project-card">
									<?php get_the_post_thumbnail($project, 'medium'); ?>
					...
					<!-- Other Collections/Related Collections -->
					<?php if($related_collect): ?>
					<div class="related-project-container container">
						<h2>Get Inspired</h2>
						<?php foreach($related_collect as $collection): ?>
